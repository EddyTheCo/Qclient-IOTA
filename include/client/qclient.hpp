...
class QCLIENT_EXPORT Client : public QObject
{
  ...
  public:
    ...
    template <qblocks::Output::types outtype> Node_outputs *get_outputs(const QString &filter)
    {
    ...
    QUrl getNodeAddress(void) const
    {
  ...
  private:
    ...
    template <qblocks::Output::types outtype> Response *get_api_indexer_v1_outputs(const QString &filter)
    {
